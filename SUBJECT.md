...
Extra mile is not working for the counting of each reaction and i cannot figure out why

[ ] Create a chat-GPT integration with the command `!prompt <prompt to be processed>` -> seems you need to pay unless you have gpt4


### Bonus

type `!cat` for a cat fact :)
